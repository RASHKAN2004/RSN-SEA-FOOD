  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center px-4 py-20">
      ...
      <p className="mt-1 text-sm text-gray-500">
        RSN Sea Food — Product & Content Management
      </p>
      ...
      <div className="mt-4 flex w-full items-center justify-between gap-3 text-xs text-gray-500">
        <Link
          href="/admin/forgot-password"
          className="font-medium text-sea-700 hover:text-sea-900"
        >
          Forgot password?
        </Link>
        <Link
      ...
      <p className="mt-4 text-xs text-gray-400">
        ...
        in the backend to create the first admin account.
      </p>
    </div>
  );
}
